  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row relative'>
        <div className='flex md:hidden p-4 bg-gray-900 text-white z-20'>
            ...
            <h1 className='ml-4 text-xl font-medium'>Giao diện quản lý</h1>
        </div>
        ...
        <div className={`bg-gray-900 w-64 md:sticky md:top-0 md:h-screen text-white absolute md:relative transform 
